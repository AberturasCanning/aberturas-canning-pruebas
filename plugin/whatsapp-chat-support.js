    ...
    (function(window, $, undefined) {
        ...
        WhatsappChatSupport.DEFAULTS = {
            ...
            timezone: 'GMT-3', // When using the date and time from the user browser you can transform it to your current timezone (in case your user is in a different timezone)
